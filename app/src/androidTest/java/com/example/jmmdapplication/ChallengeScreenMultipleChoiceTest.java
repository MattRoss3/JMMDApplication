...
public class ChallengeScreenMultipleChoiceTest {
    ...
    @Test
    public void testChallengeMultipleChoiceIntentFactory() {
        // Generate an intent using the factory method
        Intent intent = ChallengeScreenMultipleChoice.ChallengeMultipleChoiceIntentFactory(
                context,
                TEST_USER_ID,
                TEST_CHALLENGE_ID,
                TEST_CHALLENGE_NAME,
        ...
        assertEquals(ChallengeScreenMultipleChoice.class.getName(), intent.getComponent().getClassName());
    ...
    public void testActivityInitialization() {
        ...
        try (ActivityScenario<ChallengeScreenMultipleChoice> scenario = ActivityScenario.launch(intent)) {
